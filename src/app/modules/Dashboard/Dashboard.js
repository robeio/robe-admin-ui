define([
    ...
    var Dashboard = require('robe/view/RobeView').define({
        ...
        parseMetricsJson: function (json) {
            ...
            ProgressBarGroup.define().render('totalReq', 'Toplam'.i18n(), totalRequests, 'count', 1);
            ...
            metricList = [
                ...
                "Min", "min",
                "Mean", "mean"];
            var serviceList = ["io.robe.admin.resources.AuthResource.login"];
            var serviceNameList = ["AuthResource.login"];
